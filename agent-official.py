...
tools = [
    {
        ...
        "function": {
            "name": "list_mcp_tools",
            "description": "List all tools across registered official MCP fake servers",
    ...
    },
    {
        ...
        "function": {
            "name": "call_mcp_tool",
            "description": "Call one official MCP fake tool by qualified name: server.tool",
            "parameters": {
                "type": "object",
                "properties": {
...
def run_agent(user_message: str, max_iterations: int = 6) -> str:
    messages: list[Any] = [
        {
            "role": "system",
            "content": "You are a helpful assistant. Use official MCP fake tools when needed. Be concise.",
        },
